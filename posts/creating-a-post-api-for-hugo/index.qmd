...
The end state of this seemed pretty clear: I needed an api that would take a post, put a file in the repo, and then commit it, kicking off the build process I [established in a previous post]({{< relref "cicd-on-hugo.md" >}}).
